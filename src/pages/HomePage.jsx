        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Link to="/categories/fruits-vegetables" className="block text-center">
              <div className="h-24 w-24 sm:h-32 sm:w-32 mx-auto rounded-full overflow-hidden mb-4 border-2 border-green-100">
                <img 
            ...
            <Link to="/categories/beverages" className="block text-center">
              <div className="h-24 w-24 sm:h-32 sm:w-32 mx-auto rounded-full overflow-hidden mb-4 border-2 border-blue-100">
                <img 
            ...
            <Link to="/categories/bakery" className="block text-center">
              <div className="h-24 w-24 sm:h-32 sm:w-32 mx-auto rounded-full overflow-hidden mb-4 border-2 border-red-100">
                <img 
